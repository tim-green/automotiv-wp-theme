...
<ul
    class="woocommerce-mini-cart cart_list product_list_widget list-unstyled p-2 <?php echo esc_attr($args['list_class']); ?>">
    <?php
...
<p class="woocommerce-mini-cart__total total px-2 text-right">
    <?php
        /**
...
<p class="woocommerce-mini-cart__buttons buttons px-2 mb-0">
...
<p class="woocommerce-mini-cart__empty-message p-2"><?php esc_html_e('No products in the cart.', 'woocommerce'); ?></p>
